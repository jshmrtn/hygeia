defmodule HygeiaWeb.Router do
  ...
  scope "/", HygeiaWeb do
    ...
    live "/cases/new/possible-index/:form_step/:uuid/edit", CaseLive.CreatePossibleIndex, :edit
    live "/cases/new/possible-index/:form_step/:uuid/show", CaseLive.CreatePossibleIndex, :show
